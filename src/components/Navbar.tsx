    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link to="/" className="flex items-center space-x-2 group">
          <div className="w-10 h-10 bg-brand-forest flex items-center justify-center rounded-sm transition-transform group-hover:scale-110">
            <span className="text-brand-gold font-serif font-bold text-xl">AR</span>
          </div>
          <div className="flex flex-col">
            <span className="text-brand-forest font-serif font-bold text-xl leading-tight tracking-tight">AL RAA</span>
        ...
        {/* Mobile Toggle */}
        <button
          className="md:hidden text-brand-forest p-2"
